# --------------------------SetShift Habituation Protocol Task File----------------------
# This is simplist form of 5CSRT either hole 2 or hole 4 illuminates and response to illumination give reward
# cue presentation [hole-2 or hole-4] ==> Correct response @ Illuminated hole        ==> reward(@reward port)      ==> iti**
# cue presentation [hole-2 or hole-4] ==> Incorrect response @ non Illuminated hole  ==> penalty (house light off) ==> iti**
# cue presentation [hole-2 or hole-4] ==> No response (omission)                     ==> penalty (house light off) ==> iti**
...
def cue_light(event):
    ...
    # if light 2 and poke2 or light 4 and poke 4 is correct response
    elif event == 'poke_2' and v.target == 1 or event == 'poke_4' and v.target == 2:
        print('Correct_lit')
        goto_state('reward')
    # if light 4 and poke2 or light 2 and poke4 is incorrect response
    elif event == 'poke_2' and v.target != 1 or event == 'poke_4' and v.target != 2:
...
def reward(event):
    if event == 'entry':
        ...
        goto_state('iti')
    elif event == 'poke_2' and v.target == 1 \
            or event == 'poke_4' and v.target == 2:
        print('perseverate')

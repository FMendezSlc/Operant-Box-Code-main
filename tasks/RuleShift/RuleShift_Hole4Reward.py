# --------------------------RuleShift Reward for Hole-4 Protocol Task File----------------------
...
# cue presentation [2 or 4] ==> Incorrect response @ Illuminated hole2     ==> penalty (house light off) ==> iti**
...
reward_hole = 4  # by changing this to 4 can change reward for poke_4

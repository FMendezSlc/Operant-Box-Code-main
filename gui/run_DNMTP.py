...
from config.paths import data_dir, tasks_dir_DNMTP
...
class MainGui(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setWindowTitle('5-Choice_Serial_DelayedNonMatch')
        # Variables.
        # self.board = None
...
def test_data_path_1(self):
    ...
    def scan_tasks(self):
        ...
        tasks = set([t.split('.')[0] for t in os.listdir(tasks_dir_DNMTP)
                     if t[-3:] == '.py'])
        ...
        if self.task_1:
            try:
                ...
                task_path_1 = os.path.join(tasks_dir_DNMTP, task_1 + '.py')
        ...
        if self.task_2:
            try:
                ...
                task_path_2 = os.path.join(tasks_dir_DNMTP, task_2 + '.py')
        ...
        if self.task_3:
            try:
                ...
                task_path_3 = os.path.join(tasks_dir_DNMTP, task_3 + '.py')
        ...
        if self.task_4:
            try:
                ...
                task_path_4 = os.path.join(tasks_dir_DNMTP, task_4 + '.py')
        ...
        if self.task_5:
            try:
                ...
                task_path_5 = os.path.join(tasks_dir_DNMTP, task_5 + '.py')
        ...
        if self.task_6:
            try:
                ...
                task_path_6 = os.path.join(tasks_dir_DNMTP, task_6 + '.py')
        ...
        if self.task_7:
            try:
                ...
                task_path_7 = os.path.join(tasks_dir_DNMTP, task_7 + '.py')
        ...
        if self.task_8:
            try:
                ...
                task_path_8 = os.path.join(tasks_dir_DNMTP, task_8 + '.py')
        ...
        if self.connected_1:
            try:
                ...
                if self.uploaded_1:
                    ...
                    self.task_hash_1 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_1 + '.py'))
                self.pushButton_Start1.setEnabled(False)
                self.pushButton_var1.setEnabled(False)
                self.repaint()
        ...
        if self.connected_2:
            try:
                ...
                if self.uploaded_2:
                    ...
                    self.task_hash_2 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_2 + '.py'))
                self.pushButton_Start2.setEnabled(False)
                self.pushButton_var2.setEnabled(False)
                self.repaint()
        ...
        if self.connected_3:
            try:
                ...
                if self.uploaded_3:
                    ...
                    self.task_hash_3 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_3 + '.py'))
                self.pushButton_Start3.setEnabled(False)
                self.pushButton_var3.setEnabled(False)
                self.repaint()
        ...
        if self.connected_4:
            try:
                ...
                if self.uploaded_4:
                    ...
                    self.task_hash_4 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_4 + '.py'))
                self.pushButton_Start4.setEnabled(False)
                self.pushButton_var4.setEnabled(False)
                self.repaint()
        ...
        if self.connected_5:
            try:
                ...
                if self.uploaded_5:
                    ...
                    self.task_hash_5 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_5 + '.py'))
                self.pushButton_Start5.setEnabled(False)
                self.pushButton_var5.setEnabled(False)
                self.repaint()
        ...
        if self.connected_6:
            try:
                ...
                if self.uploaded_6:
                    ...
                    self.task_hash_6 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_6 + '.py'))
                self.pushButton_Start6.setEnabled(False)
                self.pushButton_var6.setEnabled(False)
                self.repaint()
        ...
        if self.connected_7:
            ...
            try:
                ...
                if self.uploaded_7:
                    ...
                    self.task_hash_7 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_7 + '.py'))
                self.pushButton_Start7.setEnabled(False)
                self.pushButton_var7.setEnabled(False)
                self.repaint()
        ...
        if self.connected_8:
            ...
            try:
                ...
                if self.uploaded_8:
                    ...
                    self.task_hash_8 = _djb2_file(os.path.join(tasks_dir_DNMTP, task_8 + '.py'))
                self.pushButton_Start8.setEnabled(False)
                self.pushButton_var8.setEnabled(False)
                self.repaint()
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(3, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_1)))
                        try:
                            ...
                            self.tableWidget.setItem(3, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_1)))
                            self.correct_sample_resp_time_1 = time.time()
                            self.tableWidget.setItem(3, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_1)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_1)))
                            ...
                            self.tableWidget.setItem(3, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_1)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_1 += 1
                        self.tableWidget.setItem(3, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_1)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_1)))
                            ...
                            self.tableWidget.setItem(3, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_1)))
                        except:
                            pass
                        ...
                        self.tableWidget.setItem(3, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_1)))
                        try:
                            ...
                            self.tableWidget.setItem(3, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_1)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_1 += 1
                        self.tableWidget.setItem(3, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_1)))
                        ...
                        self.tableWidget.setItem(3, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_1)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_1 += 1
                        self.tableWidget.setItem(3, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_1)))
                        try:
                            ...
                            self.tableWidget.setItem(3, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_1)))
                            self.correct_choice_resp_time_1 = time.time()
                            self.tableWidget.setItem(3, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_1)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_1)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_1)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_1)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_1 += 1
                        self.tableWidget.setItem(3, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_1)))
                        ...
                        self.tableWidget.setItem(3, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_1)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(3, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_1)))
                        ...
                        self.tableWidget.setItem(3, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_1)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(3, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_1)))
                        ...
                        self.tableWidget.setItem(3, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_1)))
                        ...
                        self.tableWidget.setItem(3, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_1)))
                        ...
                        self.tableWidget.setItem(3, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_1)))
                        ...
                        self.tableWidget.setItem(3, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_1)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(4, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_2)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_2)))
                            self.correct_sample_resp_time_2 = time.time()
                            self.tableWidget.setItem(4, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_2)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(4, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_2)))
                            ...
                            self.tableWidget.setItem(4, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_2)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_2 += 1
                        self.tableWidget.setItem(4, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_2)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(4, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_2)))
                            ...
                            self.tableWidget.setItem(4, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_2)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        ...
                        self.tableWidget.setItem(4, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_2)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_2)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_2 += 1
                        self.tableWidget.setItem(4, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_2)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        ...
                        self.tableWidget.setItem(4, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_2)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_2 += 1
                        self.tableWidget.setItem(4, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_2)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_2)))
                            self.correct_choice_resp_time_2 = time.time()
                            self.tableWidget.setItem(4, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_2)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(4, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_2)))
                            ...
                            self.tableWidget.setItem(4, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_2)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_2 += 1
                        self.tableWidget.setItem(4, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_2)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_2 += 1
                        self.tableWidget.setItem(4, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_2)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_2)))
                            ...
                            self.tableWidget.setItem(4, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_2)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_2 += 1
                        self.tableWidget.setItem(4, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_2)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_2 += 1
                        self.tableWidget.setItem(4, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_2)))
                    elif "delay" in str(string):
                        self.delay_start_time_2 = time.time()
                        self.tableWidget.setItem(4, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_2)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_2 += 1
                        self.tableWidget.setItem(4, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_2)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_2)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_2 += 1
                        self.tableWidget.setItem(4, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_2)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_2 += 1
                        ...
                        self.tableWidget.setItem(4, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_2)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(4, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(4, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_2)))
                        ...
                        self.tableWidget.setItem(4, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_2)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(4, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_2)))
                        ...
                        self.tableWidget.setItem(4, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_2)))
                        ...
                        self.tableWidget.setItem(4, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_2)))
                        ...
                        self.tableWidget.setItem(4, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_2)))
                        ...
                        self.tableWidget.setItem(4, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_2)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(5, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_3)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_3)))
                            self.correct_sample_resp_time_3 = time.time()
                            self.tableWidget.setItem(5, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_3)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(5, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_3)))
                            ...
                            self.tableWidget.setItem(5, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_3)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_3 += 1
                        self.tableWidget.setItem(5, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_3)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(5, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_3)))
                            ...
                            self.tableWidget.setItem(5, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_3)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        ...
                        self.tableWidget.setItem(5, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_3)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_3)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_3 += 1
                        self.tableWidget.setItem(5, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_3)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        ...
                        self.tableWidget.setItem(5, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_3)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_3 += 1
                        self.tableWidget.setItem(5, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_3)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_3)))
                            self.correct_choice_resp_time_3 = time.time()
                            self.tableWidget.setItem(5, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_3)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(5, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_3)))
                            ...
                            self.tableWidget.setItem(5, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_3)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_3 += 1
                        self.tableWidget.setItem(5, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_3)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_3 += 1
                        self.tableWidget.setItem(5, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_3)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_3)))
                            ...
                            self.tableWidget.setItem(5, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_3)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_3 += 1
                        self.tableWidget.setItem(5, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_3)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_3 += 1
                        self.tableWidget.setItem(5, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_3)))
                    elif "delay" in str(string):
                        self.delay_start_time_3 = time.time()
                        self.tableWidget.setItem(5, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_3)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_3 += 1
                        self.tableWidget.setItem(5, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_3)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_3)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_3 += 1
                        self.tableWidget.setItem(5, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_3)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_3 += 1
                        ...
                        self.tableWidget.setItem(5, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_3)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(5, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(5, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_3)))
                        ...
                        self.tableWidget.setItem(5, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_3)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(5, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_3)))
                        ...
                        self.tableWidget.setItem(5, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_3)))
                        ...
                        self.tableWidget.setItem(5, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_3)))
                        ...
                        self.tableWidget.setItem(5, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_3)))
                        ...
                        self.tableWidget.setItem(5, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_3)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(6, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_4)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_4)))
                            self.correct_sample_resp_time_4 = time.time()
                            self.tableWidget.setItem(6, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_4)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(6, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_4)))
                            ...
                            self.tableWidget.setItem(6, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_4)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_4 += 1
                        self.tableWidget.setItem(6, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_4)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(6, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_4)))
                            ...
                            self.tableWidget.setItem(6, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_4)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        ...
                        self.tableWidget.setItem(6, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_4)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_4)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_4 += 1
                        self.tableWidget.setItem(6, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_4)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        ...
                        self.tableWidget.setItem(6, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_4)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_4 += 1
                        self.tableWidget.setItem(6, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_4)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_4)))
                            self.correct_choice_resp_time_4 = time.time()
                            self.tableWidget.setItem(6, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_4)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(6, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_4)))
                            ...
                            self.tableWidget.setItem(6, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_4)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_4 += 1
                        self.tableWidget.setItem(6, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_4)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_4 += 1
                        self.tableWidget.setItem(6, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_4)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_4)))
                            ...
                            self.tableWidget.setItem(6, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_4)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_4 += 1
                        self.tableWidget.setItem(6, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_4)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_4 += 1
                        self.tableWidget.setItem(6, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_4)))
                    elif "delay" in str(string):
                        self.delay_start_time_4 = time.time()
                        self.tableWidget.setItem(6, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_4)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_4 += 1
                        self.tableWidget.setItem(6, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_4)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_4)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_4 += 1
                        self.tableWidget.setItem(6, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_4)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_4 += 1
                        ...
                        self.tableWidget.setItem(6, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_4)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(6, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(6, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_4)))
                        ...
                        self.tableWidget.setItem(6, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_4)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(6, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_4)))
                        ...
                        self.tableWidget.setItem(6, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_4)))
                        ...
                        self.tableWidget.setItem(6, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_4)))
                        ...
                        self.tableWidget.setItem(6, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_4)))
                        ...
                        self.tableWidget.setItem(6, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_4)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(7, 58,
                                                 QtWidgets.QTableWidgetItem(str(self.sample_start_time_5)))
                    elif "Correct_sample" in str(string):
                        self.Correct_sample_5 += 1
                        self.tableWidget.setItem(7, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_5)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_5)))
                            self.correct_sample_resp_time_5 = time.time()
                            self.tableWidget.setItem(7, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_5)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(7, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_5)))
                            ...
                            self.tableWidget.setItem(7, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_5)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_5 += 1
                        self.tableWidget.setItem(7, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_5)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(7, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_5)))
                            ...
                            self.tableWidget.setItem(7, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_5)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        self.iti_start_time_5 = time.time()
                        self.tableWidget.setItem(7, 60,
                                                 QtWidgets.QTableWidgetItem(str(self.iti_start_time_5)))
                    elif 'Premature_response' in str(string):
                        self.Premature_sample_5 += 1
                        self.tableWidget.setItem(7, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_5)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_5)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_5 += 1
                        self.tableWidget.setItem(7, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_5)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        self.resp_timeout_5 += 1
                        self.tableWidget.setItem(7, 31,
                                                 QtWidgets.QTableWidgetItem(str(self.resp_timeout_5)))
                    elif "choice_phase" in str(string):
                        self.choice_start_time_5 = time.time()
                        self.tableWidget.setItem(7, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_5)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_5 += 1
                        self.tableWidget.setItem(7, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_5)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_5)))
                            self.correct_choice_resp_time_5 = time.time()
                            self.tableWidget.setItem(7, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_5)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(7, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_5)))
                            ...
                            self.tableWidget.setItem(7, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_5)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_5 += 1
                        self.tableWidget.setItem(7, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_5)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_5 += 1
                        self.tableWidget.setItem(7, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_5)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_5)))
                            ...
                            self.tableWidget.setItem(7, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_5)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_5 += 1
                        self.tableWidget.setItem(7, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_5)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_5 += 1
                        self.tableWidget.setItem(7, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_5)))
                    elif "delay" in str(string):
                        self.delay_start_time_5 = time.time()
                        self.tableWidget.setItem(7, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_5)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_5 += 1
                        self.tableWidget.setItem(7, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_5)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_5)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_5 += 1
                        self.tableWidget.setItem(7, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_5)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_5 += 1
                        ...
                        self.tableWidget.setItem(7, 41,
                                                 QtWidgets.QTableWidgetItem(str(self.Receptacle_entries_5)))
                    elif '5_poke_entries' in str(string):
                        self.Nosepokes_5poke_5 += 1
                        self.tableWidget.setItem(7, 42,
                                                 QtWidgets.QTableWidgetItem(str(self.Nosepokes_5poke_5)))
                    elif 'SP_reward' in str(string):
                        self.SP_reward_5 = value[2][12:]
                        self.tableWidget.setItem(7, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_5)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(7, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(7, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_5)))
                        ...
                        self.tableWidget.setItem(7, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_5)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(7, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_5)))
                        ...
                        self.tableWidget.setItem(7, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_5)))
                        ...
                        self.tableWidget.setItem(7, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_5)))
                        ...
                        self.tableWidget.setItem(7, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_5)))
                        ...
                        self.tableWidget.setItem(7, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_5)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(8, 58,
                                                 QtWidgets.QTableWidgetItem(str(self.sample_start_time_6)))
                    elif "Correct_sample" in str(string):
                        self.Correct_sample_6 += 1
                        self.tableWidget.setItem(8, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_6)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_6)))
                            self.correct_sample_resp_time_6 = time.time()
                            self.tableWidget.setItem(8, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_6)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(8, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_6)))
                            ...
                            self.tableWidget.setItem(8, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_6)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_6 += 1
                        self.tableWidget.setItem(8, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_6)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(8, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_6)))
                            ...
                            self.tableWidget.setItem(8, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_6)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        self.iti_start_time_6 = time.time()
                        self.tableWidget.setItem(8, 60,
                                                 QtWidgets.QTableWidgetItem(str(self.iti_start_time_6)))
                    elif 'Premature_response' in str(string):
                        self.Premature_sample_6 += 1
                        self.tableWidget.setItem(8, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_6)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_6)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_6 += 1
                        self.tableWidget.setItem(8, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_6)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        self.resp_timeout_6 += 1
                        self.tableWidget.setItem(8, 31,
                                                 QtWidgets.QTableWidgetItem(str(self.resp_timeout_6)))
                    elif "choice_phase" in str(string):
                        self.choice_start_time_6 = time.time()
                        self.tableWidget.setItem(8, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_6)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_6 += 1
                        self.tableWidget.setItem(8, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_6)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_6)))
                            self.correct_choice_resp_time_6 = time.time()
                            self.tableWidget.setItem(8, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_6)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(8, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_6)))
                            ...
                            self.tableWidget.setItem(8, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_6)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_6 += 1
                        self.tableWidget.setItem(8, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_6)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_6 += 1
                        self.tableWidget.setItem(8, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_6)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_6)))
                            ...
                            self.tableWidget.setItem(8, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_6)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_6 += 1
                        self.tableWidget.setItem(8, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_6)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_6 += 1
                        self.tableWidget.setItem(8, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_6)))
                    elif "delay" in str(string):
                        self.delay_start_time_6 = time.time()
                        self.tableWidget.setItem(8, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_6)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_6 += 1
                        self.tableWidget.setItem(8, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_6)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_6)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_6 += 1
                        self.tableWidget.setItem(8, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_6)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_6 += 1
                        ...
                        self.tableWidget.setItem(8, 41,
                                                 QtWidgets.QTableWidgetItem(str(self.Receptacle_entries_6)))
                    elif '5_poke_entries' in str(string):
                        self.Nosepokes_5poke_6 += 1
                        self.tableWidget.setItem(8, 42,
                                                 QtWidgets.QTableWidgetItem(str(self.Nosepokes_5poke_6)))
                    elif 'SP_reward' in str(string):
                        self.SP_reward_6 = value[2][12:]
                        self.tableWidget.setItem(8, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_6)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(8, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(8, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_6)))
                        ...
                        self.tableWidget.setItem(8, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_6)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(8, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_6)))
                        ...
                        self.tableWidget.setItem(8, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_6)))
                        ...
                        self.tableWidget.setItem(8, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_6)))
                        ...
                        self.tableWidget.setItem(8, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_6)))
                        ...
                        self.tableWidget.setItem(8, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_6)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(9, 58,
                                                 QtWidgets.QTableWidgetItem(str(self.sample_start_time_7)))
                    elif "Correct_sample" in str(string):
                        self.Correct_sample_7 += 1
                        self.tableWidget.setItem(9, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_7)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_7)))
                            self.correct_sample_resp_time_7 = time.time()
                            self.tableWidget.setItem(9, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_7)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(9, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_7)))
                            ...
                            self.tableWidget.setItem(9, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_7)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_7 += 1
                        self.tableWidget.setItem(9, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_7)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(9, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_7)))
                            ...
                            self.tableWidget.setItem(9, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_7)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        self.iti_start_time_7 = time.time()
                        self.tableWidget.setItem(9, 60,
                                                 QtWidgets.QTableWidgetItem(str(self.iti_start_time_7)))
                    elif 'Premature_response' in str(string):
                        self.Premature_sample_7 += 1
                        self.tableWidget.setItem(9, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_7)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_7)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_7 += 1
                        self.tableWidget.setItem(9, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_7)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        self.resp_timeout_7 += 1
                        self.tableWidget.setItem(9, 31,
                                                 QtWidgets.QTableWidgetItem(str(self.resp_timeout_7)))
                    elif "choice_phase" in str(string):
                        self.choice_start_time_7 = time.time()
                        self.tableWidget.setItem(9, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_7)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_7 += 1
                        self.tableWidget.setItem(9, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_7)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_7)))
                            self.correct_choice_resp_time_7 = time.time()
                            self.tableWidget.setItem(9, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_7)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(9, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_7)))
                            ...
                            self.tableWidget.setItem(9, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_7)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_7 += 1
                        self.tableWidget.setItem(9, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_7)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_7 += 1
                        self.tableWidget.setItem(9, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_7)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_7)))
                            ...
                            self.tableWidget.setItem(9, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_7)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_7 += 1
                        self.tableWidget.setItem(9, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_7)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_7 += 1
                        self.tableWidget.setItem(9, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_7)))
                    elif "delay" in str(string):
                        self.delay_start_time_7 = time.time()
                        self.tableWidget.setItem(9, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_7)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_7 += 1
                        self.tableWidget.setItem(9, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_7)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_7)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_7 += 1
                        self.tableWidget.setItem(9, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_7)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_7 += 1
                        ...
                        self.tableWidget.setItem(9, 41,
                                                 QtWidgets.QTableWidgetItem(str(self.Receptacle_entries_7)))
                    elif '5_poke_entries' in str(string):
                        self.Nosepokes_5poke_7 += 1
                        self.tableWidget.setItem(9, 42,
                                                 QtWidgets.QTableWidgetItem(str(self.Nosepokes_5poke_7)))
                    elif 'SP_reward' in str(string):
                        self.SP_reward_7 = value[2][12:]
                        self.tableWidget.setItem(9, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_7)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(9, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(9, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_7)))
                        ...
                        self.tableWidget.setItem(9, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_7)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(9, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_7)))
                        ...
                        self.tableWidget.setItem(9, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_7)))
                        ...
                        self.tableWidget.setItem(9, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_7)))
                        ...
                        self.tableWidget.setItem(9, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_7)))
                        ...
                        self.tableWidget.setItem(9, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_7)))
                    except ZeroDivisionError:
                        pass
                ...
                for string in value:
                    ...
                    if "sample_phase" in str(string):
                        ...
                        self.tableWidget.setItem(10, 58,
                                                 QtWidgets.QTableWidgetItem(str(self.sample_start_time_8)))
                    elif "Correct_sample" in str(string):
                        self.Correct_sample_8 += 1
                        self.tableWidget.setItem(10, 8,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_sample_8)))
                        try:
                            ...
                            self.tableWidget.setItem(10, 49,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_sample_list_8)))
                            self.correct_sample_resp_time_8 = time.time()
                            self.tableWidget.setItem(10, 59,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_sample_resp_time_8)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(10, 53,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_sample_list_8)))
                            ...
                            self.tableWidget.setItem(10, 27,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_sample_mean_8)))
                        except:
                            pass
                    elif 'omission_sample' in str(string):
                        self.omission_sample_8 += 1
                        self.tableWidget.setItem(10, 25,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_sample_8)))
                    elif 'reward_sample_taken' in str(string):
                        try:
                            ...
                            self.tableWidget.setItem(10, 51,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_list_8)))
                            ...
                            self.tableWidget.setItem(10, 10,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_sample_mean_8)))
                        except:
                            pass
                    elif "iti_sample" in str(string):
                        self.iti_start_time_8 = time.time()
                        self.tableWidget.setItem(10, 60,
                                                 QtWidgets.QTableWidgetItem(str(self.iti_start_time_8)))
                    elif 'Premature_response' in str(string):
                        self.Premature_sample_8 += 1
                        self.tableWidget.setItem(10, 23,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_sample_8)))
                        try:
                            ...
                            self.tableWidget.setItem(10, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_sample_mean_8)))
                        except:
                            pass
                    elif 'perseverate_sample' in str(string):
                        self.perseverate_sample_8 += 1
                        self.tableWidget.setItem(10, 29,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_sample_8)))
                    elif 'attempts_dur_penalty_sample' in str(string):
                        self.resp_timeout_8 += 1
                        self.tableWidget.setItem(10, 31,
                                                 QtWidgets.QTableWidgetItem(str(self.resp_timeout_8)))
                    elif "choice_phase" in str(string):
                        self.choice_start_time_8 = time.time()
                        self.tableWidget.setItem(10, 61,
                                                 QtWidgets.QTableWidgetItem(str(self.choice_start_time_8)))
                    elif "Correct_choice" in str(string):
                        self.Correct_choice_8 += 1
                        self.tableWidget.setItem(10, 16,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_choice_8)))
                        try:
                            ...
                            self.tableWidget.setItem(10, 50,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_choice_list_8)))
                            self.correct_choice_resp_time_8 = time.time()
                            self.tableWidget.setItem(10, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_choice_resp_time_8)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(10, 52,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_list_8)))
                            ...
                            self.tableWidget.setItem(10, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_lat_choice_mean_8)))
                        except:
                            pass
                    elif "incorrect_choice_lit" in str(string):
                        self.incorrect_lit_choice_8 += 1
                        self.tableWidget.setItem(10, 33,
                                                 QtWidgets.QTableWidgetItem(str(self.incorrect_lit_choice_8)))
                    elif 'Incorrect_choice' in str(string):
                        self.Incorrect_choice_8 += 1
                        self.tableWidget.setItem(10, 32,
                                                 QtWidgets.QTableWidgetItem(str(self.Incorrect_choice_8)))
                        try:
                            ...
                            self.tableWidget.setItem(10, 54,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_choice_list_8)))
                            ...
                            self.tableWidget.setItem(10, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_lat_choice_mean_8)))
                        except:
                            pass
                    elif 'omission_choice' in str(string):
                        self.omission_choice_8 += 1
                        self.tableWidget.setItem(10, 37,
                                                 QtWidgets.QTableWidgetItem(str(self.omission_choice_8)))
                    elif 'Premature_choice_correct' in str(string):
                        self.Premature_choice_correct_8 += 1
                        self.tableWidget.setItem(10, 19,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_correct_8)))
                    elif "delay" in str(string):
                        self.delay_start_time_8 = time.time()
                        self.tableWidget.setItem(10, 64,
                                                 QtWidgets.QTableWidgetItem(str(self.delay_start_time_8)))
                    elif 'Premature_choice_incorrect' in str(string):
                        self.Premature_choice_incorrect_8 += 1
                        self.tableWidget.setItem(10, 43,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_choice_incorrect_8)))
                        try:
                            ...
                            self.tableWidget.setItem(10, 28,
                                                     QtWidgets.QTableWidgetItem(str(self.Premature_choice_mean_8)))
                        except:
                            pass
                    elif 'perseverate_choice' in str(string):
                        self.perseverate_choice_8 += 1
                        self.tableWidget.setItem(10, 38,
                                                 QtWidgets.QTableWidgetItem(str(self.perseverate_choice_8)))
                    elif 'attempts_dur_penalty_choice' in str(string):
                        self.resp_timeout_8 += 1
                        ...
                        self.tableWidget.setItem(10, 41,
                                                 QtWidgets.QTableWidgetItem(str(self.Receptacle_entries_8)))
                    elif '5_poke_entries' in str(string):
                        self.Nosepokes_5poke_8 += 1
                        self.tableWidget.setItem(10, 42,
                                                 QtWidgets.QTableWidgetItem(str(self.Nosepokes_5poke_8)))
                    elif 'SP_reward' in str(string):
                        self.SP_reward_8 = value[2][12:]
                        self.tableWidget.setItem(10, 4,
                                                 QtWidgets.QTableWidgetItem(str(self.SP_reward_8)))
                    elif 'Event Closing' in str(string):
                        self.tableWidget.setItem(10, 0,
                                                 QtWidgets.QTableWidgetItem(str(self.date)))
                    try:
                        ...
                        self.tableWidget.setItem(10, 30,
                                                 QtWidgets.QTableWidgetItem(str(self.per_perseverate_sample_8)))
                        ...
                        self.tableWidget.setItem(10, 9,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_sample_8)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(10, 15,
                                                 QtWidgets.QTableWidgetItem(str(self.per_correct_choice_8)))
                        ...
                        self.tableWidget.setItem(10, 17,
                                                 QtWidgets.QTableWidgetItem(str(self.per_omission_choice_8)))
                        ...
                        self.tableWidget.setItem(10, 14,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_choice_8)))
                        ...
                        self.tableWidget.setItem(10, 13,
                                                 QtWidgets.QTableWidgetItem(str(self.per_accuracy_lit_choice_8)))
                        ...
                        self.tableWidget.setItem(10, 20,
                                                 QtWidgets.QTableWidgetItem(str(self.trial_choice_8)))
                    except ZeroDivisionError:
                        pass

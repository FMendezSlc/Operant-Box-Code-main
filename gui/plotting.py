...
from gui_settings import event_history_len, state_history_len, analog_history_dur

# Task_plotter -----------------------------------------------------------------------


class Task_plotter(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.verticalLayout_graph.addWidget(self.states_plot.axis,1)
        self.verticalLayout_graph.addWidget(self.events_plot.axis,1)
        self.verticalLayout_graph.addWidget(self.analog_plot.axis,1)
        self.setLayout(self.verticalLayout_graph)

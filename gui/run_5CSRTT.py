...
class MainGui(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setWindowTitle('5-Choice Serial Reaction Time Test')
        # Variables.
        # self.board = None
...
#-------------------------------------------------------------------           
    ...
    def table_fill(self):
        ...
        self.tableWidget.setItem(1, 4,
                                 QtWidgets.QTableWidgetItem(str('per_accuracy')))
        self.tableWidget.setItem(1, 5,
                                 QtWidgets.QTableWidgetItem(str('per_omission')))
        self.tableWidget.setItem(1, 6,
                                 QtWidgets.QTableWidgetItem(str('per_correct')))
        self.tableWidget.setItem(1, 7,
                                 QtWidgets.QTableWidgetItem(str('num_correct')))
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(2, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_1)))
                        try:
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(2, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_1)))
                            self.incorrect_cv_1 = self.incorrect_stdev_1 / self.incorrect_mean_1
                            self.tableWidget.setItem(2, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_1)))
                        except:
                            pass
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(2, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_1)))
                        except:
                            pass
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(2, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_1)))
                        #per_omission
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(3, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_2)))
                        try:
                            ...
                            self.tableWidget.setItem(3, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_2)))
                            self.correct_cv_2 = self.correct_stdev_2 / self.correct_mean_2
                            self.tableWidget.setItem(3, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_2)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_2 += 1
                        self.tableWidget.setItem(3, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_2)))
                        try:
                            ...
                            self.tableWidget.setItem(3, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_2)))
                            self.incorrect_cv_2 = self.incorrect_stdev_2 / self.incorrect_mean_2
                            self.tableWidget.setItem(3, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_2)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(3, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_2)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_2 += 1
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(3, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_2)))
                        #per_omission
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(4, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_3)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_3)))
                            self.correct_cv_3 = self.correct_stdev_3 / self.correct_mean_3
                            self.tableWidget.setItem(4, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_3)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_3 += 1
                        self.tableWidget.setItem(4, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_3)))
                        try:
                            ...
                            self.tableWidget.setItem(4, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_3)))
                            self.incorrect_cv_3 = self.incorrect_stdev_3 / self.incorrect_mean_3
                            self.tableWidget.setItem(4, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_3)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(4, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_3)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_3 += 1
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(4, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_3)))
                        #per_omission
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(5, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_4)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_4)))
                            self.correct_cv_4 = self.correct_stdev_4 / self.correct_mean_4
                            self.tableWidget.setItem(5, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_4)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_4 += 1
                        self.tableWidget.setItem(5, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_4)))
                        try:
                            ...
                            self.tableWidget.setItem(5, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_4)))
                            self.incorrect_cv_4 = self.incorrect_stdev_4 / self.incorrect_mean_4
                            self.tableWidget.setItem(5, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_4)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(5, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_4)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_4 += 1
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(5, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_4)))
                        #per_omission
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(6, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_5)))
                        try:
                            self.correct_latency_5 = time.time() - self.sample_start_time_5
                            self.correct_cv_list_5.append(self.correct_latency_5)                            
                            self.correct_time_start_5 = time.time()                            
                            self.correct_lat_5 = [float(i) for i in self.correct_cv_list_5]
                            self.correct_stdev_5 = statistics.stdev(self.correct_lat_5)                            
                            self.correct_mean_5 = statistics.mean(self.correct_lat_5)
                            self.tableWidget.setItem(6, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_5)))
                            self.correct_cv_5 = self.correct_stdev_5 / self.correct_mean_5
                            self.tableWidget.setItem(6, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_5)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_5 += 1
                        self.tableWidget.setItem(6, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_5)))
                        try:
                            self.incorrect_latency_5 = time.time() - self.sample_start_time_5
                            self.incorrect_cv_list_5.append(self.incorrect_latency_5)
                            
                            self.incorrect_lat_5 = [float(i) for i in self.incorrect_cv_list_5]
                            self.incorrect_stdev_5 = statistics.stdev(self.incorrect_lat_5)
                            
                            self.incorrect_mean_5 = statistics.mean(self.incorrect_lat_5)
                            self.tableWidget.setItem(6, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_5)))
                            self.incorrect_cv_5 = self.incorrect_stdev_5 / self.incorrect_mean_5
                            self.tableWidget.setItem(6, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_5)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.reward_latancy_cv_list_5.append(self.reward_latancy_latency_5)
                            
                            self.reward_latancy_lat_5 = [float(i) for i in self.reward_latancy_cv_list_5]
                            self.reward_latancy_stdev_5 = statistics.stdev(self.reward_latancy_lat_5)                           
                            self.reward_latancy_mean_5 = statistics.mean(self.reward_latancy_lat_5)
                            ...
                            self.tableWidget.setItem(6, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_5)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_5 += 1
                    ...
                    try:
                        #number of trials
                        self.Choice_state_5 = self.omission_5 + self.Correct_response_5 \
                                              + self.Incorrect_response_5 + self.Premature_response_5
                        self.tableWidget.setItem(6, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_5)))
                        #per_omission
                        self.per_omission_5 = (self.omission_5 / (self.omission_5 + self.Correct_response_5
                                                                  + self.Incorrect_response_5)) * 100
                        self.tableWidget.setItem(6, 5,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_omission_5)))
                        #per_accuracy
                        self.per_accuracy_5 = (self.Correct_response_5 / (self.Correct_response_5
                                                                          + self.Incorrect_response_5)) * 100
                        self.tableWidget.setItem(6, 4,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_accuracy_5)))
                        #per_accuracy
                        self.per_correct_5 = (self.Correct_response_5 / (self.Correct_response_5
                                                                         + self.Incorrect_response_5
                                                                         + self.omission_5)) * 100
                        self.tableWidget.setItem(6, 6,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_correct_5)))
                        #per_premature
                        self.per_premature_5 = (self.Premature_response_5 / self.Choice_state_5) * 100
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(7, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_6)))
                        try:
                            self.correct_latency_6 = time.time() - self.sample_start_time_6
                            self.correct_cv_list_6.append(self.correct_latency_6)                            
                            self.correct_time_start_6 = time.time()                            
                            self.correct_lat_6 = [float(i) for i in self.correct_cv_list_6]
                            self.correct_stdev_6 = statistics.stdev(self.correct_lat_6)                            
                            self.correct_mean_6 = statistics.mean(self.correct_lat_6)
                            self.tableWidget.setItem(7, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_6)))
                            self.correct_cv_6 = self.correct_stdev_6 / self.correct_mean_6
                            self.tableWidget.setItem(7, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_6)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_6 += 1
                        self.tableWidget.setItem(7, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_6)))
                        try:
                            self.incorrect_latency_6 = time.time() - self.sample_start_time_6
                            self.incorrect_cv_list_6.append(self.incorrect_latency_6)
                            
                            self.incorrect_lat_6 = [float(i) for i in self.incorrect_cv_list_6]
                            self.incorrect_stdev_6 = statistics.stdev(self.incorrect_lat_6)
                            
                            self.incorrect_mean_6 = statistics.mean(self.incorrect_lat_6)
                            self.tableWidget.setItem(7, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_6)))
                            self.incorrect_cv_6 = self.incorrect_stdev_6 / self.incorrect_mean_6
                            self.tableWidget.setItem(7, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_6)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.reward_latancy_cv_list_6.append(self.reward_latancy_latency_6)
                            
                            self.reward_latancy_lat_6 = [float(i) for i in self.reward_latancy_cv_list_6]
                            self.reward_latancy_stdev_6 = statistics.stdev(self.reward_latancy_lat_6)                           
                            self.reward_latancy_mean_6 = statistics.mean(self.reward_latancy_lat_6)
                            ...
                            self.tableWidget.setItem(7, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_6)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_6 += 1
                    ...
                    try:
                        #number of trials
                        self.Choice_state_6 = self.omission_6 + self.Correct_response_6 \
                                              + self.Incorrect_response_6 + self.Premature_response_6
                        self.tableWidget.setItem(7, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_6)))
                        #per_omission
                        self.per_omission_6 = (self.omission_6 / (self.omission_6 + self.Correct_response_6
                                                                  + self.Incorrect_response_6)) * 100
                        self.tableWidget.setItem(7, 5,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_omission_6)))
                        #per_accuracy
                        self.per_accuracy_6 = (self.Correct_response_6 / (self.Correct_response_6
                                                                          + self.Incorrect_response_6)) * 100
                        self.tableWidget.setItem(7, 4,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_accuracy_6)))
                        #per_accuracy
                        self.per_correct_6 = (self.Correct_response_6 / (self.Correct_response_6
                                                                         + self.Incorrect_response_6
                                                                         + self.omission_6)) * 100
                        self.tableWidget.setItem(7, 6,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_correct_6)))
                        #per_premature
                        self.per_premature_6 = (self.Premature_response_6 / self.Choice_state_6) * 100
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(8, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_7)))
                        try:
                            self.correct_latency_7 = time.time() - self.sample_start_time_7
                            self.correct_cv_list_7.append(self.correct_latency_7)                            
                            self.correct_time_start_7 = time.time()                            
                            self.correct_lat_7 = [float(i) for i in self.correct_cv_list_7]
                            self.correct_stdev_7 = statistics.stdev(self.correct_lat_7)                            
                            self.correct_mean_7 = statistics.mean(self.correct_lat_7)
                            self.tableWidget.setItem(8, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_7)))
                            self.correct_cv_7 = self.correct_stdev_7 / self.correct_mean_7
                            self.tableWidget.setItem(8, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_7)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_7 += 1
                        self.tableWidget.setItem(8, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_7)))
                        try:
                            self.incorrect_latency_7 = time.time() - self.sample_start_time_7
                            self.incorrect_cv_list_7.append(self.incorrect_latency_7)
                            
                            self.incorrect_lat_7 = [float(i) for i in self.incorrect_cv_list_7]
                            self.incorrect_stdev_7 = statistics.stdev(self.incorrect_lat_7)
                            
                            self.incorrect_mean_7 = statistics.mean(self.incorrect_lat_7)
                            self.tableWidget.setItem(8, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_7)))
                            self.incorrect_cv_7 = self.incorrect_stdev_7 / self.incorrect_mean_7
                            self.tableWidget.setItem(8, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_7)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.reward_latancy_cv_list_7.append(self.reward_latancy_latency_7)
                            
                            self.reward_latancy_lat_7 = [float(i) for i in self.reward_latancy_cv_list_7]
                            self.reward_latancy_stdev_7 = statistics.stdev(self.reward_latancy_lat_7)                           
                            self.reward_latancy_mean_7 = statistics.mean(self.reward_latancy_lat_7)
                            ...
                            self.tableWidget.setItem(8, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_7)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_7 += 1
                    ...
                    try:
                        #number of trials
                        self.Choice_state_7 = self.omission_7 + self.Correct_response_7 \
                                              + self.Incorrect_response_7 + self.Premature_response_7
                        self.tableWidget.setItem(8, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_7)))
                        #per_omission
                        self.per_omission_7 = (self.omission_7 / (self.omission_7 + self.Correct_response_7
                                                                  + self.Incorrect_response_7)) * 100
                        self.tableWidget.setItem(8, 5,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_omission_7)))
                        #per_accuracy
                        self.per_accuracy_7 = (self.Correct_response_7 / (self.Correct_response_7
                                                                          + self.Incorrect_response_7)) * 100
                        self.tableWidget.setItem(8, 4,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_accuracy_7)))
                        #per_accuracy
                        self.per_correct_7 = (self.Correct_response_7 / (self.Correct_response_7
                                                                         + self.Incorrect_response_7
                                                                         + self.omission_7)) * 100
                        self.tableWidget.setItem(8, 6,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_correct_7)))
                        #per_premature
                        self.per_premature_7 = (self.Premature_response_7 / self.Choice_state_7) * 100
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(9, 7,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Correct_response_8)))
                        try:
                            self.correct_latency_8 = time.time() - self.sample_start_time_8
                            self.correct_cv_list_8.append(self.correct_latency_8)                            
                            self.correct_time_start_8 = time.time()                            
                            self.correct_lat_8 = [float(i) for i in self.correct_cv_list_8]
                            self.correct_stdev_8 = statistics.stdev(self.correct_lat_8)                            
                            self.correct_mean_8 = statistics.mean(self.correct_lat_8)
                            self.tableWidget.setItem(9, 14,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.correct_mean_8)))
                            self.correct_cv_8 = self.correct_stdev_8 / self.correct_mean_8
                            self.tableWidget.setItem(9, 13,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.correct_cv_8)))
                        except:
                            pass
                    elif 'Incorrect_response' in str(string):
                        self.Incorrect_response_8 += 1
                        self.tableWidget.setItem(9, 16,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Incorrect_response_8)))
                        try:
                            self.incorrect_latency_8 = time.time() - self.sample_start_time_8
                            self.incorrect_cv_list_8.append(self.incorrect_latency_8)
                            
                            self.incorrect_lat_8 = [float(i) for i in self.incorrect_cv_list_8]
                            self.incorrect_stdev_8 = statistics.stdev(self.incorrect_lat_8)
                            
                            self.incorrect_mean_8 = statistics.mean(self.incorrect_lat_8)
                            self.tableWidget.setItem(9, 17,
                                                     QtWidgets.QTableWidgetItem("{:.2f}".format(self.incorrect_mean_8)))
                            self.incorrect_cv_8 = self.incorrect_stdev_8 / self.incorrect_mean_8
                            self.tableWidget.setItem(9, 23,
                                                     QtWidgets.QTableWidgetItem("{:.4f}".format(self.incorrect_cv_8)))
                        except:
                            pass
                    elif "iti_start_time" in str(string):
                        ...
                        try:
                            ...
                            self.reward_latancy_cv_list_8.append(self.reward_latancy_latency_8)
                            
                            self.reward_latancy_lat_8 = [float(i) for i in self.reward_latancy_cv_list_8]
                            self.reward_latancy_stdev_8 = statistics.stdev(self.reward_latancy_lat_8)                           
                            self.reward_latancy_mean_8 = statistics.mean(self.reward_latancy_lat_8)
                            ...
                            self.tableWidget.setItem(9, 25,
                                                     QtWidgets.QTableWidgetItem(
                                                         "{:.2f}".format(self.reward_latancy_cv_8)))
                        except:
                            pass
                    elif 'omission' in str(string):
                        self.omission_8 += 1
                    ...
                    try:
                        #number of trials
                        self.Choice_state_8 = self.omission_8 + self.Correct_response_8 \
                                              + self.Incorrect_response_8 + self.Premature_response_8
                        self.tableWidget.setItem(9, 10,
                                                 QtWidgets.QTableWidgetItem("{:.0f}".format(self.Choice_state_8)))
                        #per_omission
                        self.per_omission_8 = (self.omission_8 / (self.omission_8 + self.Correct_response_8
                                                                  + self.Incorrect_response_8)) * 100
                        self.tableWidget.setItem(9, 5,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_omission_8)))
                        #per_accuracy
                        self.per_accuracy_8 = (self.Correct_response_8 / (self.Correct_response_8
                                                                          + self.Incorrect_response_8)) * 100
                        self.tableWidget.setItem(9, 4,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_accuracy_8)))
                        #per_accuracy
                        self.per_correct_8 = (self.Correct_response_8 / (self.Correct_response_8
                                                                         + self.Incorrect_response_8
                                                                         + self.omission_8)) * 100
                        self.tableWidget.setItem(9, 6,
                                                 QtWidgets.QTableWidgetItem("{:.2f}".format(self.per_correct_8)))
                        #per_premature
                        self.per_premature_8 = (self.Premature_response_8 / self.Choice_state_8) * 100
